  ...
  "config": {
    ...
    "flow_agent_function_tools": [
        ...
        "input_schema": {
          ...
          "properties": {
            ...
            "alcance_agente": {
              ...
              "description": "Hasta dónde tiene que llegar el agente (7 pts, el de mayor peso). Un bot que solo responde preguntas frecuentes vale poco; uno que agenda, cobra e integra con sus sistemas es el mejor cliente."
            },
            "sistemas_a_integrar": {
              "type": "string",
              "enum": [
              ...
              "description": "Con qué hay que conectar el agente (6 pts). Si menciona un sistema con API —agenda, ERP, CRM, pasarela de pago— es la mejor señal: hay dónde integrar y hay presupuesto."
            },
            "especificidad_dolor": {
              "type": "string",
              "enum": [
              ...
              "description": "TU EVALUACIÓN de qué tan concreto es el problema que describe (6 pts). NO se lo preguntes: júzgalo por cómo habla. Si nombra el proceso Y las herramientas (\"me preguntan precios todo el día por WhatsApp y anoto en un cuaderno\") es lo máximo."
            },
            "volumen_conversaciones": {
              ...
              "description": "Cuántas consultas de WhatsApp recibe al mes (5 pts). Preguntalo con naturalidad; si no sabe, usa \"No sabe\", que no penaliza casi nada."
            },
            "rol_lead": {
              "type": "string",
              "enum": [
      ...
      },
      {
        ...
        "description": "Bloquea el número de forma permanente y CORTA la conversación en silencio. Llamar apenas la persona escriba una grosería, un insulto o un garabato, sin darle otra oportunidad. Después de llamarla NO escribas absolutamente nada —ni una despedida— y llamá a complete_task. Cualquier texto que produzcas se le envía por WhatsApp, y despedirse invita a que siga.",
        "function_id": "97aa8274-2a91-4354-a220-dc6e62e99f5c",
        "function_name": "guardar-lead",
        "input_schema": {
          "type": "object",
          "properties": {
            "motivo_bloqueo": {
              "type": "string",
              "description": "Por qué se bloquea, en pocas palabras, citando lo que escribió. Queda guardado para que José pueda revisar y desbloquear si fue un falso positivo. Ej: 'Insultos: \"andate a la mierda\"'."
            },
            "telefono": {
              "type": "string",
              "description": "Teléfono del lead. Si viene del contexto de WhatsApp se puede omitir."
